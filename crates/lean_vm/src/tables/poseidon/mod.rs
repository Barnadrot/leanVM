...
// virtual columns (deterministic — intermediates pinned by AIR constraints + memory-bound I/O)
...
pub(super) struct Poseidon1Cols16<T> {
    ...
    // virtual columns (deterministic intermediates — pinned by AIR + memory-bound I/O)
